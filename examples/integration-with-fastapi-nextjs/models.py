...
class FacebookContentRequest(BaseModel):
    content: str
    model: Optional[str] = "gemini/gemini-2.0-flash"
    num_images: int = 1
    generate_images: bool = True
    analysis_model: Optional[str] = "gemini/gemini-2.0-flash"
    content_model: Optional[str] = "gemini/gemini-2.0-flash"
    image_model: Optional[str] = "gemini/gemini-2.0-flash"
    image_generator: Optional[str] = "stable_diffusion"
...
class MediumContentRequest(BaseModel):
    content: str
    model: Optional[str] = "gemini/gemini-2.0-flash"
    num_images: int = 1
    generate_images: bool = True
...
class StarterPackRequest(BaseModel):
    ...
    packaging_style: Optional[str] = "collector_blister"
    vision_model: Optional[str] = "gemini/gemini-2.0-flash"
    prompt_model: Optional[str] = "openai/gpt-4o-mini"
    generator: Optional[str] = "dalle"

class CSVExplorerRequest(BaseModel):
    csv_paths: List[str]
    output_dir: Optional[str] = "./csv_explorer_output"
    model: Optional[str] = "openai/gpt-4o-mini"

class TalkWithDocumentRequest(BaseModel):
