...
class LogConfig:
    ...
    @staticmethod
    def get_log_level():
        """Get the configured log level, defaulting to INFO if invalid"""
        valid_levels = ["TRACE", "DEBUG", "INFO", "SUCCESS", "WARNING", "ERROR", "CRITICAL"]
        level = LogConfig.LOG_LEVEL.upper()
    ...
    def setup_logging(cls):
        ...
        logger.add(console_sink, level=cls.get_log_level())
        
        # Add our JSON sink
        logger.add(cls.json_sink, level=cls.get_log_level())
