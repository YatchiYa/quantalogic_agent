...
from .controllers import agent_router, file_router, task_router, health_router, validation_router, generation_router, conversation_router, message_router, message_conversation_router_public, tools, chat_router, chrome_scheduler_router
...
# Add file logger to save logs to agent.logs at the root of the project
project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))
log_file_path = os.path.join(project_root, "agents.log")
logger.add(
    log_file_path,
...
app.include_router(chrome_scheduler_router)
        ...
        try:
            while not server_state.is_shutting_down:
                ...
                try:
                    ...
                    event_str = f"event: {event.event}\ndata: {json.dumps(event_data, cls=CustomJSONEncoder)}\n\n"
