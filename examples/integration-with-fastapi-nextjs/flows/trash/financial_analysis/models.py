...
class StrategyAnalysis(BaseModel):
    """LLM-based analysis of market strategies."""
    market_overview: str = ""  # Overall market assessment
    trend_analysis: str = ""  # Detailed trend analysis
    key_levels_assessment: str = ""  # Assessment of support/resistance levels
    technical_indicator_insights: str = ""  # Insights from technical indicators
    pattern_recognition: str = ""  # Analysis of identified patterns
    smart_money_perspective: str = ""  # Smart money movement analysis
    recommended_strategies: str = ""  # Recommended strategies with rationale
    risk_assessment: str = ""  # Risk assessment for current market conditions
    timeframe_recommendations: str = ""  # Strategy recommendations per timeframe
    trade_opportunities: str = ""  # Specific trade opportunities
    market_psychology: str = ""  # Analysis of market psychology
    confidence_score: float = 0.0  # Overall confidence in the analysis (0-1)
...
class MarketAnalysis(BaseModel):
    ...
    strategy_llm_analysis: Optional[StrategyAnalysis] = None  # LLM-based strategy analysis
